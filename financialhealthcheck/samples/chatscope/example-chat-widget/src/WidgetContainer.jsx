...
export const WidgetContainer = ({greeting = "Hello, I'm Aroc. How can I help you today?"}) => {
    ...
    const handleSend = async (message) => {
        ...
        const prompt = 
            "You are a financial advisor AI called Aroc that works for NatWest Bank based solely in the UK.\n" 
