...
Transaction
{{transaction_id: INTEGER, transaction_date: DATE, narrative: STRING, type: STRING, amount: INTEGER, balance: INTEGER}},
"date format is 2024-02-15" "narrative can only be one of the following: {narrative_options}"
