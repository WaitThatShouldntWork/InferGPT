...
@tool_metadata(
    ...
    description="Generates Cypher query to extract information from the database",
    parameters={
        "user_prompt": Parameter(
            type="string",
            description="question provided by the user",
        )
    },
)
...
def generate_cypher(user_prompt: str):
    ...
    print("this is the llm query" + llm_query)
