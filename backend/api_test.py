...
# def test_health_check_response_backend_unhealthy(mocker):
#     mock_connection_test = mocker.patch("api.test_connection")
...
#     assert response.status_code == 500
#     assert response.json() == unhealthy_backend_response
